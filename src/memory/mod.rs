...
impl Memory {
    ...
    pub fn read_byte(&self, addr: u16) -> u8 {
        match addr {
            ...
            UNUSED_ADDR..=UNUSED_ADDR_END => panic!("Attempted to read from unused memory at address {:#06x}", addr),
    ...
    pub fn write_byte(&mut self, addr: u16, value: u8) {
        match addr {
            ...
            UNUSED_ADDR..=UNUSED_ADDR_END => {
                panic!("Attempted to write to unused memory at address {:#06x}", addr);
            }
